...
const HeroSection = () => {
    ...
    const getFeatures = async () => {
        try {
            let featureData = await fetch("http://localhost:4000/api/getFeatures/64e1a443fe5f89f405beb429");
            if (featureData.ok) {
    ...
    return (
        <section className="bg-white dark:bg-gray-900">
            <div className="grid max-w-screen-xl px-0 py-0 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
